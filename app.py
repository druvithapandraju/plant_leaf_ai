...
tf.keras.utils.get_custom_objects()["CapsuleLayer"] = CapsuleLayer
...
def predict_image(filepath):
    ...
    if disease_key != "healthy":
        ...
        for cnt in contours:
            if cv2.contourArea(cnt) > 500:
                ...
                cv2.circle(infected_img, (x, y), r, (0, 0, 255), 2)
    ...
    return {
        ...
        "description": f"{plant_name} is affected by {disease_name}.",
